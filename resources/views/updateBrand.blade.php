...
<head>
	...
	<link rel="stylesheet" type="" href="css/styleInsertBrand.css">
</head>
<body onload="renderTime();">
	...
	<div class="body_content">
		...
		<div class="container">
			<div class="loginbox">
				<h1>Update Brand</h1>
				<form action="{{URL::to('/updateManageBrand')}}" method="POST">
					{{@csrf_field()}}
					<input type="text" name="name" placeholder="Name Brand">
					<input type="submit" name="" value="Update Brand">
				</form>
			</div>
		</div>
