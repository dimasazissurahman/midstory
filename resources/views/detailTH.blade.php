...
<head>
	...
	<link rel="stylesheet" type="" href="css/styleDetailTH.css">
</head>
<body onload="renderTime();">
	<div class="top" >
		<div id="img1">
			<li><a href="memberPage.html"><img src="picture/logo.jpg"></a></li>
		</div>
	...
	<div class="body_content">
		<div class="container">
			<h1>Transaction History Detail<img src="picture/cart.png"></h1>
			<table>
			  <tr>
			  	<th>Phone</th>
			  	<th>Price</th>
			...
			<div class="body-bottom">
				<h2 id="totalQty">Total Qty : 2 | </h2>
				<h2 id="grandTotal">Grand Total : 180000</h2>
				<h2> |</h2><br>
				<h4><a href="transactionHistory"><button id="btnBack">Back</button></a></h4>
			</div>
		</div>
