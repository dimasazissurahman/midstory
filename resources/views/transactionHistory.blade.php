...
<head>
	...
	<link rel="stylesheet" type="" href="css/styleTH.css">
</head>
<body onload="renderTime();">
	...
	<div class="body_content">
		<div class="container">
			<h1>Transaction History<img src="picture/cart.png"></h1>
			<table>
			  <tr>
			  	<th>ID</th>
			  	<th>Email</th>
			  ...
			  <tr>
			    <td>1</td>
			    <td>kelvin@gmail.com</td> 
			    <td>2018-08-08 00:00:00</td>
			    <td>Success</td>
			    <td><a href="detailTH"><button id="btnDetail"> Detail</button></a></td>
			  </tr>
			</table>
		</div>
